...
const GameList = ({
  ...
  return (
    <div className="game-list">
      <img src={image || game.logo_url} alt={name || game.name} className="game-image" />
      <div className="game-info">
        <h2>{name || game.name}</h2>
        <p className="game-state"><strong>Estado:</strong> {state || game.company_owner.company_name}</p>
        ...
        {mode === "stats" && (
          <>
            ...
            <p>
              ...
              CANTIDAD DE VISUALIZACIONES: {views}
            </p>
